...
//            logger.info("Test is running on Local");
    ...
    public WebDriver getLocalDriver(String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            System.setProperty("webdriver.chrome.driver","C:\\Users\\asus\\Desktop\\micro-wave-master\\Generic\\selenium-browser-driver\\chromedriver.exe");
            driver = new ChromeDriver();
        }else if(browserName.equalsIgnoreCase("firefox")){
            System.setProperty("webdriver.gecko.driver","C:\\Users\\asus\\Desktop\\micro-wave-master\\Generic\\selenium-browser-driver\\geckodriver.exe");
            driver = new FirefoxDriver();
        } else if(browserName.equalsIgnoreCase("ie")) {
            System.setProperty("webdriver.ie.driver", "C:\\Users\\asus\\Desktop\\micro-wave-master\\Generic\\selenium-browser-driver\\IEDriverServer.exee");
    ...
    public WebDriver getLocalGridDriver(String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            ...
            System.setProperty("webdriver.ie.driver", "C:\\Users\\asus\\Desktop\\micro-wave-master\\Generic\\selenium-browser-driver\\IEDriverServer.exe");
            driver = new InternetExplorerDriver();
        }
        return driver;
    }
